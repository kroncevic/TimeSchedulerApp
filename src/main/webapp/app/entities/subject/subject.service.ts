...
export class SubjectService {
    ...
    create(subject: ISubject): Observable<EntityResponseType> {
        return this.http.post<ISubject>(this.resourceUrl, subject, {
            observe: "response"
        });
    }

    update(subject: ISubject): Observable<EntityResponseType> {
        return this.http.put<ISubject>(this.resourceUrl, subject, {
            observe: "response"
        });
    }

    find(id: number): Observable<EntityResponseType> {
        return this.http.get<ISubject>(`${this.resourceUrl}/${id}`, {
            observe: "response"
        });
    }
    ...
    query(req?: any): Observable<EntityArrayResponseType> {
        ...
        return this.http.get<ISubject[]>(this.resourceUrl, {
            params: options,
            observe: "response"
        });
    }
