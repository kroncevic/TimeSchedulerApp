...
import hr.tvz.config.Constants;
import hr.tvz.TimeSchedulerApp;
import hr.tvz.domain.Authority;
import hr.tvz.domain.PersistentToken;
import hr.tvz.domain.User;
import hr.tvz.repository.AuthorityRepository;
import hr.tvz.repository.PersistentTokenRepository;
import hr.tvz.repository.UserRepository;
import hr.tvz.security.AuthoritiesConstants;
import hr.tvz.service.MailService;
import hr.tvz.service.dto.UserDTO;
import hr.tvz.service.dto.PasswordChangeDTO;
import hr.tvz.web.rest.errors.ExceptionTranslator;
import hr.tvz.web.rest.vm.KeyAndPasswordVM;
import hr.tvz.web.rest.vm.ManagedUserVM;
import hr.tvz.service.UserService;
...
@SpringBootTest(classes = TimeSchedulerApp.class)
